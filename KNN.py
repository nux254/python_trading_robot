...
df = pd.read_csv('Data/calculatedData.csv')

exists = os.path.isfile('Pkl/saved_model_knn.pkl')
if exists:
    os.remove('Pkl/saved_model_knn.pkl')
...
joblib.dump(clf, 'Pkl/saved_model_knn.pkl')

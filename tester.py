...
clf_load_knn = joblib.load('Pkl/saved_model_knn.pkl')
clf_load_lr = joblib.load('Pkl/saved_model_lr.pkl')
clf_load_nn = joblib.load('Pkl/saved_model_nn.pkl')
clf_load_rf = joblib.load('Pkl/saved_model_rf.pkl')
clf_load_svm = joblib.load('Pkl/saved_model_svm.pkl')
